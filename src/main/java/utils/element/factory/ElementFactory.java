...
public class ElementFactory {
  ...
  /**
   * As {@link ElementFactory#initElements(WebDriver, Class)} but will only replace the fields of an
  ...
  /**
   * Copy of {@link PageFactory # instantiatePage(org.openqa.selenium.WebDriver, Class)}
   */
